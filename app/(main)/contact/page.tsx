    ...
    <>
      ...
      <div className="container mb-24">
        <div className="flex flex-col">
          <Typography variant="text_title" className='py-8'>Love to hear from you</Typography>
          ...
          <Typography variant="text_main" className='mt-8'>
            Have a question, thought or something you would like to share? <br /> You
            are welcome to reach out. I read every message and will get back to
