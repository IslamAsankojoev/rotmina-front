...
import type { CreateOrderRequest, OrderResponse, OrderListResponse, PayOrderRequest, OrderResponseStrapi } from './types'
...
export const OrderService = {
  ...
  payOrder: (order: PayOrderRequest): Promise<OrderResponse> =>
