...
export const CategoryService = {
  ...
  getCategoryBySlug: (slug: string): Promise<CategoryFindOneResponse> => api.get(apiMap.getCategoryBySlug.replace(':slug', slug) + '?populate=image&populate=top_image').json(),
}